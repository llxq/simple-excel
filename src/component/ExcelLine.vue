...
const calcAreaLinePosition = () => {
  ...
  const { left: tableLeft, top: tableTop } = excelBuilder.excelTableRect;
  showSelectAreaLine.value = true;
  ...
  style.value = {
    ...
    top: toPx(finalTop - excelBuilder.scrollOffset.top - tableTop),
    left: toPx(finalLeft - excelBuilder.scrollOffset.left - tableLeft),
  };
};
...
watchPostEffect(() => {
  if (
    ...
    excelBuilder.recalculateSelectAreaFlag
  ) {
